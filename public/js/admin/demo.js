...
$(document).ready(function(){
  ...
  var album = document.getElementById("album");   // Get the checkbox
  var album_list = document.getElementById("album_list");    // Get the output text 
  
  if(album)
  {
    album.onchange = function() {    // If the checkbox is checked, display the output text
      if (album.checked == true){
        album_list.style.display = "block";
      } else {
        album_list.style.display = "none";
        $("#album_list option").removeAttr('selected');
      }
    }
  }


  var artist = document.getElementById("artist");   // Get the checkbox
  var artist_list = document.getElementById("artist_list");    // Get the output text 
  
  if(artist)
  { 
    artist.onchange = function() {    // If the checkbox is checked, display the output text
      if (artist.checked == true){
        artist_list.style.display = "block";
      } else {
        artist_list.style.display = "none";
        $("#artist_list option").removeAttr('selected');
      }
    }
  }


  var playlist = document.getElementById("playlist");   // Get the checkbox
  var playlist_list = document.getElementById("playlist_list");    // Get the output text 
 
  if(playlist)
  {
    playlist.onchange = function() {    // If the checkbox is checked, display the output text
      if (playlist.checked == true){
        playlist_list.style.display = "block";
      } else {
        playlist_list.style.display = "none";
        $("#playlist_list option").removeAttr('selected');
      }
    }
  }


  var track = document.getElementById("track");   // Get the checkbox
  var track_list = document.getElementById("track_list");    // Get the output text 
  
  if(track)
  {
    track.onchange = function() {    // If the checkbox is checked, display the output text
      if (track.checked == true){
        track_list.style.display = "block";
      } else {
        track_list.style.display = "none";
        $("#track_list option").removeAttr('selected');
      }
    }
  }
