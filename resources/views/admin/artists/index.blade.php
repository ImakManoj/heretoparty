    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ url('/admin/artists/create') }}" class="btn btn-success btn-sm" title="Add New Content">
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                @foreach($contents as $item)
                                    <tr>
                                        ...
                                        <td>
                                           <!--  <?php
                                            $picture = Controller::getFilePath($item->image, 'artists');
                                                if($picture) { ?>
...
<td>{{ strlen(@$item->description) > 20 ? substr(@$item->description, 0, 20)."..." : @$item->description  }}</td>
                                        <td>
                                            <a href="{{ url('/admin/artists/' . $item->id) }}" title="View Content"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> </button></a>
                                            <a href="{{ url('/admin/artists/' . $item->id . '/edit') }}" title="Edit Content"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></a>
