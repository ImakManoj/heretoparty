...
<div class="container-fluid">
    <div class="col-md-12">
     ...
     <br />
     <div class="card">
        <div class="card-header">Create New Voice</div>
        <div class="card-body">
                <form method="POST" action="{{ url('/admin/voiceSave') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                    @csrf
