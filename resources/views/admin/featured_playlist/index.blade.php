    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="title">Featured Playlist</h4>
                <a href="{{ url('/admin/featured_playlist/create') }}" class="btn btn-success btn-sm" title="Add New Song">
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                @foreach($results as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="{{ url('/admin/featured_playlist' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
