             ...
             <form action="{{route('AdminProfileUpdate')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-6">
                  <div class="form-group form-group-default">
                    <label>Phone</label>
                    <input type="text" class="form-control" name="phone" placeholder="Phone" value="{{@$Profile->contact}}" maxlength="12">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group form-group-default">
                    <label>Address</label>
                    <input type="text" class="form-control" id="address" value="{{@$Profile->address}}" name="address" placeholder="Address">
